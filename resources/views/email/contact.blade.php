                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%"
                                                            ...
                                                            <tr>
                                                                <td align="center"
                                                                    ...
                                                                    <img src="https://szveum.stripocdn.email/content/guids/CABINET_f3fc38cf551f5b08f70308b6252772b8/images/96671618383886503.png"
                                                                        alt
                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Dear Admin!<br><br>
                                                                        You have a New Contact Mail with the followin details:
                                                                        <hr>
                                                                        Name: {{ $datafield['name'] }}<br>
                                                                        Email: {{ $datafield['email'] }}<br>
                                                                        Subject: {{ $datafield['subject'] }}<br>
                                                                        message: {{ $datafield['message'] }}<br>
                                                                        <hr>
                                                                        <b>Thanks!!!</b>
                                                                    </p>
                                                                </td>
