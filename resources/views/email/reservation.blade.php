                                                            ...
                                                            <tr>
                                                                <td align="left"
                                                                    ...
                                                                    <p
                                                                        ...
                                                                        Dear Admin!<br><br>
                                                                        You have a New Reservation Request with the followin details:
                                                                        <hr>
                                                                        Name: {{ $data['name'] }}<br>
                                                                        Email: {{ $data['email'] }}<br>
                                                                        Phone: {{ $data['phone'] }}<br>
                                                                        No. of Persons: {{ $data['persons'] }}<br>
                                                                     	Reservation Date: {{ $data['date_on'] }}<br>
                                                                         Reservation Time: {{ $data['time_on'] }}<br>
                                                                        <hr>
                                                                        <b>Thanks!!!</b>
                                                                    </p>
                                                                </td>
